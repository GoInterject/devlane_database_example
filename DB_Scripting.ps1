...
# ReportingDatabase
powershell.exe -File "C:\Users\jeffh\OneDrive\Documents\GitRepos\devlane_database_example\GenerateSqlScripts_v2.ps1" "." "ReportingDatabase_Test" "Interject_Reporting" "C:\Users\jeffh\OneDrive\Documents\GitRepos\devlane_database_example\DB" true false true
